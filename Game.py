...
direction_strings = {Directions.NORTH:'n', Directions.EAST:'e', Directions.SOUTH:'s', Directions.WEST:'w', Directions.NONE:'o'}
...
class Position:
    ...
    def move(self, dir):
        return Position((self.x + dir[0]) % Game.WIDTH, (self.y + dir[1]) % Game.HEIGHT)
    def around(self):
